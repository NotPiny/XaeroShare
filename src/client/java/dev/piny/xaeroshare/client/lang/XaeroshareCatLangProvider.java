...
public class XaeroshareCatLangProvider extends FabricLanguageProvider {
    public XaeroshareCatLangProvider(FabricPackOutput dataOutput, CompletableFuture<HolderLookup.Provider> registryLookup) {
        // Specifying en_us is optional, as it's the default language code
        super(dataOutput, "lol_us", registryLookup);
    }

    @Override
    public void generateTranslations(HolderLookup.Provider registries, TranslationBuilder translationBuilder) { // TURNS OUT IT'S STUPIDLY HARD TO WRITE LOLCAT 😭
        // Keybinds
